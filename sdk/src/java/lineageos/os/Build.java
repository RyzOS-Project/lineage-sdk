...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.ryz.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.ryz.display.version");
